...
namespace ProjectManagement.Infrastructure.Data
{
    public static class ProjectManagementDataInMemory 
    {
        ...
        public static List<Project> projects =new()
        {
            ...
            new (){ProjectId = 1001,ProjectName="2022 Q2 Product Plan",DepartmentId=1, MaxHours = 600, StartDate = new DateOnly( 2022,1,4), EndDate = new DateOnly(2022,7,31) },
            new (){ProjectId = 1002,ProjectName="2022 Q3 Product Plan",DepartmentId=1, MaxHours = 700, StartDate = new DateOnly( 2022,1,7), EndDate =new DateOnly(2022,10,31)  },
            new (){ProjectId = 1003,ProjectName="2022 Q4 Product Plan",DepartmentId=1, MaxHours = 800, StartDate =new DateOnly( 2022,1,10) , EndDate =new DateOnly(2022,12,31)  },
            ...
            new (){ProjectId = 1005,ProjectName="2022 Q2 Portfolio Analysis",DepartmentId=2, MaxHours = 400, StartDate =new DateOnly( 2022,1,4) , EndDate = new DateOnly(2022,7,31) },
            new (){ProjectId = 1006,ProjectName="2022 Q3 Portfolio Analysis",DepartmentId=2, MaxHours = 900, StartDate = new DateOnly(2022,1,7), EndDate =new DateOnly(2022,10,31) },
            new (){ProjectId = 1007,ProjectName="2022 Q4 Portfolio Analysis",DepartmentId=2, MaxHours = 800, StartDate =new DateOnly( 2022,1,10) , EndDate =new DateOnly(2022,12,31) },
            ...
            new (){ProjectId = 1009,ProjectName="2022 Q2 Tax Preparation",DepartmentId=3, MaxHours = 850, StartDate =new DateOnly( 2022,1,4), EndDate =new DateOnly(2022,7,31) },
            new (){ProjectId = 1010,ProjectName="2022 Q3 Tax Preparation",DepartmentId=3, MaxHours = 900, StartDate =new DateOnly(2022,1,7) , EndDate =new DateOnly(2022,10,31) },
            new (){ProjectId = 1011,ProjectName="2022 Q4 Tax Preparation",DepartmentId=3, MaxHours = 800, StartDate =new DateOnly( 2022,1,10), EndDate =new DateOnly(2022,12,31) }
        };
