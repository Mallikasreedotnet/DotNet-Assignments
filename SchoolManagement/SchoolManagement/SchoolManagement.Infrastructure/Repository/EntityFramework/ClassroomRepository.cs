...
namespace SchoolManagement.Infrastructure.Repository.EntityFramework
{
    public class ClassroomRepository : IClassroomRepository
    {
        ...
        public ClassroomRepository(SchoolManagementDbContext schoolDbContext, IDbConnection dbconnection,IExamResultService examResultService,IExamResultRepository examResultRepository)
        {
